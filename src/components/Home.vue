        ...
        <div class=" ">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <div class="flex flex-col justify-center md:w-full items-center p-[20px] gap-[21px]">
                    <div
                        class=" grid-rows-2 flex flex-row justify-between items-center p-0 md:gap-[51px] text-sky-900 sm:gap-[20px]">
            ...
            <div class="md:flex flex-row flex-start ms-3 mt-0  left-[0.29px] right-[0.29px] top-0 ">
                <div class="pe-2 ">
                    <div class="w-fit overflow-hidden">
                        <img src="../assets/unsplash.png" alt="unsplash" class="w-full h-auto relative z-0 rounded-lg transition-all duration-700 hover:scale-110 ">
                ...
                <div class="pe-2 ">
                    <div class="w-fit overflow-hidden">
                        <img src="../assets/SwitzerlandImage.png" alt="unsplash" class="w-full h-auto relative z-0 rounded-lg transition-all duration-700 hover:scale-110" >
                        <div class="flex flex-row items-center  justify-between   pb-[8px] ">
                ...
                <div class="pe-2">
                    <div class="w-fit overflow-hidden">
                        <img src="../assets/BoracayImage.png" alt="borcay" class="w-full h-auto relative z-0 rounded-lg transition-all duration-700 hover:scale-110">
                ...
                <div class="pe-2">
                    <div class="w-fit overflow-hidden">
                        <img src="../assets/PalawanImage.png" alt="unsplash" class="w-full h-auto relative z-0 rounded-lg transition-all duration-700 hover:scale-110">
                        <div class="flex flex-row items-center p-0 justify-between   pb-[8px] ">
                            <div class="flex flex-col items-center p-0 gap-[6px]">
                                <div class=" mt-3 ">
        ...
        <div class="flex flex-col md:flex-row flex-start color2 p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-3  text-white gap-4">
                ...
                <div class="flex flex-col">
                    <p class="mb-2 font-bold">Company</p>
                    <p>About Us</p>
                    <p>News</p>
                    <p>Careers</p>
                    <p>How we work</p>
...
.back:hover {
    box-shadow: 5px 5px rgb(185, 114, 126);
    transition: 2s;
    scale: 1.23;
    overflow: hidden;   
}
...
.back1:hover {
    box-shadow: 5px 5px rgb(168, 126, 63);
    transition: 2s;
    scale: 1.23;
    overflow: hidden;   
}
...
.back2:hover{
    box-shadow: 5px 5px rgb(60, 145, 60);
    transition: 2s;
    scale: 1.23;
    overflow: hidden;   
}
